...
public class Parser {
    ...
    public void parse(Page page, String contextURL)
        throws NotAllowedContentException, ParseException, IOException {
        if (Util.hasBinaryContent(page.getContentType())) { // BINARY
            ...
            //Use LanguageDetector instead...2018-6-28
            LanguageDetector detector = new OptimaizeLangDetector().loadModels();
            LanguageResult languageResult = detector.detect(parsedData.getText());
            page.setLanguage(languageResult.getLanguage());
